...
pro fig_mucol, datfil, NTOT=NTOT, CSIZE=csize, PSFILE=psfile, XTINT=xtint, $
...
;      readf, 11, wrest, ymin, ymax, nblnd
          spec_fil = ''
          readf, 11, spec_fil
          readcol, root+spec_fil, velo, fx, sig, format='D,F,F', /silen
          readf, 11, wrest, flg
          readf, 11, ymin, ymax
          ymnx = [ymin, ymax]
