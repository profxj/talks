...
pro fig_dndx_ovi, summ_fil, ALL_GAL=all_gal
  ...
  ;;;;;;;;;;;;;;;;;;;;
     ...
     if qq GT 1 then begin
        ...
        xyouts, 1., yhalo, 'Halo', color=clr.black, charsi=lsz, align=0.5
     endif
  ...
  ;;;;;;;;;;;;;;;;;;;;
     ...
     if qq GT 2 then $
        x_curvefill, [1.75,2.25], [0., 0.], replicate(subls_dndx2,2), $
                     color=clr.cyan, /line_fil, orient=-45.
     if qq GT 1 then begin
        x_curvefill, [1.75,2.25], [0., 0.], replicate(subls_dndx,2), color=clr.cyan
        xyouts, 2., yhalo, 'Halo', color=clr.black, charsi=lsz, align=0.5
     endif
  ...
  ;;;;;;;;;;;;;;;;;;;;
     ...
     if qq GT 1 then begin
        ...
        xyouts, 3., yhalo, 'Halo', color=clr.black, charsi=lsz, align=0.5
     endif
