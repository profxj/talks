...
pro qpq6_correlation, COVFACT = COVFACT, psfile = psfile, outfile = outfile, NOPS=nops, $
  ...
  if not keyword_set( PSFILE ) then psfile = 'qpq6_correlation.ps'
  ...
  for ss=0,2 do begin
     ...
     ;; y label
     if ss EQ 1 then ytit = '!9c!X!d'+perpletter+'!N (R,!9D!Xv)' else ytit = ''
